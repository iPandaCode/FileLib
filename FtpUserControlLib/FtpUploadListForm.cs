...
{
    public partial class FtpUploadListForm : Form
    {
        #region 属性
        /// <summary>
        /// 初始化标记
        ...
        public void Init()
        {
            ...
            for (int i = 0; i < FtpHelper.FtpUploadFileInfoList.Count(); i++)
            {
                ftpListUserControl1.Add(FtpHelper.FtpUploadFileInfoList[i]);
            }
            _IsInit = true;
        }
        #endregion
